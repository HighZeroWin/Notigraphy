...
using Notigraghy.View.CreateNote;
using Notigraghy.View.Feed;
using Notigraghy.View.NoteList;
using Notigraghy.View.QuickNote;
using System;
using System.Linq;
using Xamarin.Forms;
...
namespace Notigraghy.View
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public Command TabQuickNoteCommand { get; set; }
        ...
        private void InitializeCommands()
        {
            ...
            TabQuickNoteCommand = new Command(ExecuteTabQuickNote);
;        }
        ...
        //퀵노트 선택 시
        private void ExecuteTabQuickNote(object obj)
        {
            BodyView = new QuickNoteView();
        }
    }
}
